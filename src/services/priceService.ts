...
export class PriceService {
  ...
  async fetchPricesForChainAndFetcher(chainId: number, fetcher: string): Promise<void> {
    logger.info(`🔄 Starting price refresh for chain ${chainId} with fetcher: ${fetcher}...`)
    try {
