...
const skipPatterns = [
  'DeFiLlama returned', 'CoinGecko returned', 'Fetching prices for',
  'Stored', 'from cache', '[Velodrome]', 'DeFiLlama:', 'CoinGecko:'
];
...
export const setLogLevel = (level: string) => logger.level = level;
export const setSilentMode = (silent: boolean) => logger.silent = silent;
